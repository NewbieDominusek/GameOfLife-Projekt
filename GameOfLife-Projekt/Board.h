...
class TileMap : public sf::Drawable
{
	...
	int numer;	//Wymiary tablicy i zmienna pomocnicza
...
public:
	...
	TileMap(Mapa *cellMap, int wW, int wH);	//konstruktor, trzeba daæ tablicê z komórkami, rozmiary tablicy oraz rozmiary okna
